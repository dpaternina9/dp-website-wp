...
final class PackageTypeTest extends TestCase {
	...
	public function test_offer_filter_names(): void {
		$this->assertSame(
			'update_themes_updates.dpaternina.com',
			PackageType::Theme->offer_filter( 'updates.dpaternina.com' )
		);
		$this->assertSame(
			'update_plugins_updates.dpaternina.com',
			PackageType::Plugin->offer_filter( 'updates.dpaternina.com' )
		);
	}
