# ADR-0021 — The blog templates derive four things a template cannot say

## Status

Accepted — 2026-08-25. *Renumbered from 0015 on 2026-08-29: ADR-0015 was
taken by the wp-update-client adoption, merged to `main` in PR #1 while this
branch was in flight. The published number won; this one moved.* **Partly superseded by
