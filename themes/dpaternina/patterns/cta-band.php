...
<section class="wp-block-group alignfull dp-cta-band"><!-- wp:heading {"className":"dp-cta-band__title"} -->
<h2 class="wp-block-heading dp-cta-band__title"><?php esc_html_e( "Let's build something.", 'dpaternina' ); ?></h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"className":"dp-cta-band__line"} -->
<p class="dp-cta-band__line"><?php esc_html_e( 'Product work, agency projects, or just a note about espresso, guitars, or cats. All welcome.', 'dpaternina' ); ?></p>
<!-- /wp:paragraph -->
