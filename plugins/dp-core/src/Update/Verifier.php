...
final class Verifier {
	 ...
	 * @param string[]|null $package_hosts Hosts a package URL may point at, or null for the default.
	 */
	public function __construct(
		private readonly string $public_key,
		private readonly ?array $package_hosts = null
	) {}
	...
	public function open( string $envelope_json ): Manifest {
		...
		return Manifest::from_array( json_decode( $payload, true ), $this->package_hosts );
	}
